...
DATA_PATH=/root
python -m torch.distributed.launch --nproc_per_node=4 --master_port 23904 \
main_pretrain.py --do_train --num_thread_reader=8 \
--epochs=3 --batch_size=768 --n_display=50 \
...
--output_dir ckpts/ckpt_pretrain_logsoftmax_tempsimsiam_0.1_2M_1e-4_b16_768_tempratiolnpost \
