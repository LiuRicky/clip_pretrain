...
python -m torch.distributed.launch --nproc_per_node=8 --master_port 23900 \
...
--output_dir ckpts/ckpt_pretrain_msrvtt_ts2net_random_tempsimsiam_mmsimsiam \
--lr 1e-4 --max_words 32 --max_frames 12 --batch_size_val 32 \
--datatype msrvtt --expand_msrvtt_sentences  \
--feature_framerate 1 --coef_lr 1e-3 \
--freeze_layer_num 0  --slice_framepos 2 \
--loose_type --linear_patch 2d --sim_header seqTransf \
--init_model ckpts/ckpt_pretrain_tempsimsiam_mmsimsiam/pytorch_model.bin.2 \
