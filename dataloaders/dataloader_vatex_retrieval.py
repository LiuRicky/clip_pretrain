...
class VATEX_DataLoader(Dataset):
    ...
    def __init__(
        ...
        video_id_path_dict = {}
        video_id_path_dict["train"] = os.path.join(self.data_path, "trn_names.npy")
        video_id_path_dict["val"] = os.path.join(self.data_path, "tst_names.npy")
        video_id_path_dict["test"] = os.path.join(self.data_path, "tst_names.npy")
        caption_file = os.path.join(self.data_path, 'ref_captions.json')

        video_ids = np.load(video_id_path_dict[self.subset])
